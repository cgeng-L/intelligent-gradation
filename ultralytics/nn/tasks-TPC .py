...
from ultralytics.nn.attention.CoT import CoT3
from ultralytics.nn.attention.CARAFE import CARAFE
from ultralytics.nn.attention.ODConv import ODConv
...
def parse_model(d, ch, verbose=True):  # model_dict, input_channels(3)
    ...
    for i, (f, n, m, args) in enumerate(d['backbone'] + d['head']):  # from, number, module, args
        ...
        if m in (Classify, Conv, ConvTranspose, GhostConv, Bottleneck, GhostBottleneck, SPP, SPPF, DWConv, Focus,
                 BottleneckCSP, C1, C2, C2f, C3, C3TR, C3Ghost, nn.ConvTranspose2d, DWConvTranspose2d, C3x, RepC3, CoT3, CARAFE, ):
            c1, c2 = ch[f], args[0]
